/**
	...
	@ Sc no enc silahkan cek https://github.com/Anjarman200/Man-Bot-Multi
...
module.exports = man = async (man, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [man.user.id, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        const itsMe = m.sender == man.user.id ? true : false
        ...
        // Group
        const botNumber = man.user.id ? man.user.id.split(":")[0]+"@s.whatsapp.net" : man.user.id
        const groupMetadata = m.isGroup ? await man.groupMetadata(from) : ''
		...
		const reply = async (teks) => {
			return await man.sendFakeLink(m.chat,teks,salam, pushname,ownername, thumbnail, myweb, m)
		}
		// DATABASE
try {
...
user.afkReason = ''
        ...
        if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antilink && !isCreator && !isGroupAdmins && !isGroupOwner){
        	...
        	man.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu akan dikeluarkan dari group ${groupMetadata.subject}`}, {quoted:m})
			man.groupParticipantsUpdate(m.chat, [sender], 'remove')
		}
	}
		...
		const sendFileFromUrl = async (from, url, caption, mek, men) => {
            ...
            if (mime.split("/")[1] === "gif") {
                return man.sendMessage(from, { video: await getBuffer(url), caption: caption, gifPlayback: true, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m})
                }
            let type = mime.split("/")[0]+"Message"
            if(mime === "application/pdf"){
                return man.sendMessage(m.chat, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, mentions: men ? men : []}, {quoted: mek })
            }
            if(mime.split("/")[0] === "image"){
                return man.sendMessage(m.chat, { image: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
            }
            if(mime.split("/")[0] === "video"){
                return man.sendMessage(m.chat, { video: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m})
            }
            if(mime.split("/")[0] === "audio"){
                return man.sendMessage(m.chat, { audio: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'audio/mpeg'}, {quoted: m })
            }
        }
        
/*if(autorecording){
	if(autorecording== true) return
	await man.sendPresenceUpdate('recording', m.chat)
	} else if(autoketik){
		if(autoketik == true) return
		await man.sendPresenceUpdate('composing', m.chat)
		} else if(available){
			if(available == true) return
			man.sendPresenceUpdate('available', m.chat)
			}*/
...
if (budy.toLowerCase() == jawaban) {
	man.sendButtonText(m.chat, [{ buttonId: 'math medium', buttonText: { displayText: 'Kuis Math' }, type: 1 }], ` 🎮 Kuis Matematika🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? kirim ${prefix}math *mode*`, `© ${ownername}`, m)
...
${isSurender ? '' : ``}`.trim()
man.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak bendera', buttonText: { displayText: 'Tebak Bendera' }, type: 1 }], `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'caklontong', buttonText: { displayText: 'Cak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'susunkata', buttonText: { displayText: 'Susun Kata' }, type: 1 }], `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak siapa', buttonText: { displayText: 'Tebak Siapa' }, type: 1 }], `🎮 Tebak Siapa 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tekateki', buttonText: { displayText: 'Teka Teki' }, type: 1 }], `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak kabupaten', buttonText: { displayText: 'Tebak Kabupaten' }, type: 1 }], `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak kimia', buttonText: { displayText: 'Tebak Kimia' }, type: 1 }], `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await man.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, `© ${ownername}`, m)
...
man.sendReadReceipt(m.chat, sender, [m.key.id])
}
...
if (!(from in global.db.data.absen)) return man.send1ButMes(m.chat, `Tidak ada absen berlangsung di group ini !`, `© ${ownername}`, `absenstart`, `Mulai Absen`, m)
...
Total: ${absen.length}
`.trim()
await man.send2ButMes(m.chat, caption, `© ${ownername}`, `absen`, `Absen`, `cekabsen`, `Cek Absen`, m, absen)

//man.sendTextWithMentions(m.chat, caption, m)
break
case 'cekabsen':{
	if (m.isGroup) { 
  if (!(isGroupAdmins || isCreator))return reply(lang.adminOnly())
...
Total: ${absenn.length}
`.trim()
man.send2ButMes(m.chat, captionn, `© ${ownername}`, `absen`, `Absen`, `deleteabsen`, `Hapus Absen`, m, absenn)

//man.sendTextWithMentions(m.chat, captionn, m)
}
break
...
global.db.data.absen = global.db.data.absen || {}
if (from in global.db.data.absen)return man.send2ButMes(m.chat, `Masih ada sesi absen di group ini !`, `© ${ownername}`, `cekabsen`, `Cek Absen`, `deleteabsen`, `Hapus Absen`, m)

global.db.data.absen[from] = [
  await man.send1ButMes(m.chat, `Absen dimulai...`, `© ${ownername}`, `absen`, `Absen`, m),
...
`).join('\n')}
`.trim()
man.sendTextWithMentions(m.chat, teks, m)
}
break
case 'lockcmd': {
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                man.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
                let msgs = JSON.parse(fs.readFileSync('./database/database.json'))
	...
	case 'antiviewonce': case 'antionce':
        ...
        reply(`${command} Berhasil Di Nonaktifkan !`)
        	...
        	man.sendButMessage(from, 'Mode Anti View Once', `© ${ownername}`, [{buttonId: 'antionce on', buttonText: {displayText: 'ON'}, type: 1},{buttonId: 'antionce off', buttonText: {displayText: 'OFF'}, type: 1}], {quoted: fgif})
			}
			break
        ...
        reply(`${command} Berhasil Di Nonaktifkan !`)
        	...
        	man.sendButMessage(from, 'Mode Auto Respond', `© ${ownername}`, [{buttonId: 'autorespond on', buttonText: {displayText: 'ON'}, type: 1},{buttonId: 'autorespond off', buttonText: {displayText: 'OFF'}, type: 1}], {quoted: fgif})
			}}
			break
...
if (!m.isGroup) return reply(lang.groupOnly())
        ...
        reply(`Bot Berhasil Di UnMute`)
        	...
        	man.sendButMessage(from, 'Mode Mute', `© ${ownername}`, [{buttonId: 'mute on', buttonText: {displayText: 'ON'}, type: 1},{buttonId: 'mute off', buttonText: {displayText: 'OFF'}, type: 1}], {quoted: fgif})
			}
			break
        	case 'nsfw':
        if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
        ...
        reply(`NsFw Berhasil Di Nonaktifkan !`)
        	...
        	man.sendButMessage(from, 'Mode Nfsw', `© ${ownername}`, [{buttonId: 'nsfw on', buttonText: {displayText: 'ON'}, type: 1},{buttonId: 'nsfw off', buttonText: {displayText: 'OFF'}, type: 1}], {quoted: fgif})
			}
			break
			case 'antilink':
			if (!m.isGroup) return reply(lang.groupOnly())
			...
			if (args[0] === "on") {
				...
				reply(`Antilink Berhasil Di Aktifkan !`)
					...
					reply(`Antilink Berhasil Di Nonaktifkan !`)
						...
						man.sendButMessage(from, 'Mode Antilink', `© ${ownername}`, [{buttonId: 'antilink on', buttonText: {displayText: 'ON'}, type: 1},{buttonId: 'antilink off', buttonText: {displayText: 'OFF'}, type: 1}], {quoted: fgif})
						}
					break
            ...
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    man.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    man.chatModify({ mute: null }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    man.chatModify({  archive: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    man.chatModify({ archive: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    man.chatModify({ markRead: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    man.chatModify({ markRead: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    man.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
            ...
            case 'linkgroup': case 'linkgrup': case 'linkgc': {
                ...
                let response = await man.groupInviteCode(m.chat)
                man.sendText(m.chat, `Link Group : *${groupMetadata.subject}*\nhttps://chat.whatsapp.com/${response}`, m, { detectLink: true })
            }
            break
            case 'delete': case 'del': {
                ...
                man.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
	    case 'toimage': case 'toimg': {
                ...
                reply(lang.wait())
                let media = await man.downloadAndSaveMediaMessage(quoted)
                let ran = await getRandom('.png')
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    fs.unlinkSync(media)
                    if (err) throw 'Maaf Saat Ini Belum Support Sticker Gif '
                    let buffer = fs.readFileSync(ran)
                    man.sendMessage(m.chat, { image: buffer }, { quoted: m })
                    fs.unlinkSync(ran)
                })
            }
            break
            case 'pinterest': {
				...
				await man.send5ButImg(from, `Hasil percarian ${text}` , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
				.catch((err) => {
                    reply(lang.err())
                })
				}
            ...
            case 'owner': case 'creator': {
                man.sendContact(m.chat, global.owner, m)
            }
            break
            case 'rules':{
            ...
            var but = [
				...
				await man.send5ButImg(from, lang.rules(prefix), `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
				}
            break
...
"id": 'command'
        ...
        await man.send5ButImg(from, lang.tos(ownernomer) , `© ${ownername}`,qris, but , { userJid: m.chat, quoted: m })
    }
 break
...
//Random Anime
				case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
					...
					.then(({data}) => {
						man.sendMediaAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
				...
				case 'waifu': case 'loli':
					...
					.then(({data}) => {
					man.sendImage(m.chat, data.url, lang.ok(), m)
					})
					break
...
let encmedia = await man.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply(`Kirim/Reply Gambar/Video Dengan Caption ${prefix + command}\n\nDurasi Sticker Video 1-9 Detik☕`)
let media = await quoted.download()
let encmedia = await man.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
break
			case 'setppbot': case 'setpp': {
                ...
                let media = await man.downloadAndSaveMediaMessage(quoted)
                await man.updateProfilePicture(man.user.id, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(lang.ok())
                }
                break
			case 'setppgroup': case 'setppgrup': case 'setppgc': {
                ...
                if (/webp/.test(mime)) throw `Kirim/Reply Image Dengan Caption ${prefix + command}`
                let media = await man.downloadAndSaveMediaMessage(quoted)
                await man.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(lang.ok())
                }
                break    
            ...
            man.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            ...
            let media = await quoted.download()
            let audio = await toAudio(media, 'mp4')
            man.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${man.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            man.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break        
            ...
            case 'anime':{
				...
				await man.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(lang.err())
                })
            ...
            case 'soundcloud':{
				...
				await man.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                    ...
                    man.sendMessage(from, {audio : {url : data.medias[0].url}, fileName: `${data.title}.mp3`, mimetype: 'audio/mpeg'}, {quoted: m})
                    }
                    break
		...
		let wokwol = await man.serializeM(await m.getQuotedObj())
            ...
            case 'listchat': case 'listpc': {
             ...
             case 'liston': case 'listonline':{
             	if (!isGroupAdmins && !isGroupOwner) return reply(mess.admin)
                    ...
                    man.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
                    }
                    break
                 case 'olistgc': {

if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
getGroups = await man.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
let teks = `⬣ *LIST GROUP CHAT*\n\nTotal Group : ${anu.length} Group\n\n`
for (let i of anu) {
let metadata = await man.groupMetadata(i)
...
break
             ...
             case 'setname': case 'setsubject': {
                ...
                await man.groupUpdateSubject(m.chat, text).then((res) => m.reply(lang.ok())).catch((err) => m.reply(jsonformat(err)))
            }
            break
             case 'setdesc': case 'setdesk': case 'setdeskripsi':{
				...
				if (!isBotAdmins) return reply(lang.botNotAdmin())
				if (!text) return reply(`Kirim perintah ${prefix + command} *teks*`)
				man.groupUpdateDescription(m.chat, `${args.join(" ")}`)
				reply(lang.ok())
				}
				break
...
let media = await man.downloadAndSaveMediaMessage(quoted)
await man.updateProfilePicture(groupId, { url: media }).catch((err) => fs.unlinkSync(media))
reply(lang.ok())
}
break
            case 'join': {
                ...
                await man.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'tagall': case 'infoall':
                ...
                tekss += `\n⋙ *${botname}* ⋘`
                man.sendMessage(from, { text: tekss, mentions: participants.map(a => a.id) }, { quoted: fkontak })
            break
            case 'hidetag':
                if (!m.isGroup) return reply(lang.groupOnly())
                if (!(isGroupAdmins || isGroupOwner )) return reply(lang.adminOnly())
                man.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, {quoted: fkontak})
            break
            case 'kick': {
				if (!m.isGroup) return reply(lang.groupOnly())
                if (!isBotAdmins) return reply(lang.botNotAdmin())
				...
				await man.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
				}
				break
			case 'add': {
				if (!m.isGroup) return reply(lang.groupOnly())
				...
				await man.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
				}
				break
			case 'promote': {
				if (!m.isGroup) return reply(lang.groupOnly())
                ...
                if (!m.quoted && !text) return reply(`Kirim nomer/tag/reply target yang ingin di promote !`)
				let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
				await man.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
				}
				break
			case 'demote': {
				if (!m.isGroup) return reply(lang.groupOnly())
				...
				let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
				await man.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
				}
				break
			case 'revoke':
                if (!m.isGroup) return reply(lang.groupOnly())
                if (!isBotAdmins) return reply(lang.botNotAdmin())
                if (!(isGroupAdmins || isGroupOwner )) return reply(lang.adminOnly())
                let link = await man.groupRevokeInvite(from)
                await reply(lang.ok() + `\n\n*New Link for ${groupName}* :\n https://chat.whatsapp.com/${link}`)
            break
            case 'out':
                if (!m.isGroup) return reply(lang.groupOnly())
                if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
               reply('Sayonara~ 👋').then(async res => await man.groupLeave(from))
            break
            case 'group': case 'grup':
                ...
                if (!(isGroupAdmins || isGroupOwner )) return reply(lang.adminOnly())
                if (args[0] === 'open'){
                    await man.groupSettingUpdate(from, 'not_announcement')
		 		   reply(lang.ok())
                } else if (args[0] === 'close'){
                    await man.groupSettingUpdate(from, 'announcement')
                    reply(lang.ok())
                } else {
                    man.sendButMessage(from, 'GROUP SETTING', `© ${ownername}`, [{buttonId: 'group open', buttonText: {displayText: 'Open'}, type: 1},{buttonId: 'group close', buttonText: {displayText: 'Close'}, type: 1}], {quoted: fgif})
                }
            break 
			case 'afk': {
if (!m.isGroup) return reply(lang.groupOnly())
...
id: 'family100'+m.chat,
 pesan: await man.sendText(m.chat, hasil, m),
...random,
...
man.sendMedia(m.chat, result.img, '', m, { caption: `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s` }).then(() => {
console.log("Jawaban: " + result.jawaban)
tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
man.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} 
case 'tebakkata': {
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
console.log("Jawaban: " + result.jawaban)
tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
man.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebakkata[m.sender.split('@')[0]]
}
} 
case 'tebakbendera': {
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendMedia(m.chat, result.img, '', m, { caption: `Silahkan Jawab Pertanyaan Diatas\n\nWaktu : 60s` }).then(() => {
console.log("Jawaban: " + result.name)
tebakbendera[m.sender.split('@')[0]] = result.name.toLowerCase()
})
await sleep(60000)
if (tebakbendera.hasOwnProperty(m.sender.split('@')[0])) {
man.sendButtonText(m.chat, [{ buttonId: 'tebak bendera', buttonText: { displayText: 'Tebak Bendera' }, type: 1 }], "Waktu Habis\nJawaban: " + result.name , `© ${ownername}`, m)
delete tebakbendera[m.sender.split('@')[0]]
}
} 
case 'tebakkalimat': {
...
man.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
} 
case 'tebaksiapa': {
...
man.sendButtonText(m.chat, [{ buttonId: 'tebak siapa', buttonText: { displayText: 'Tebak Siapa' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
delete siapaaku[m.sender.split('@')[0]]
}
} 
case 'tebakkabupaten':{
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendImage(m.chat, result.url, `Gambar Diatas Adalah Gambar dari Kabupaten?\nWaktu : 60s`, m).then(() => {
console.log("Jawaban: " + result.title)
tebakkabupaten[m.sender.split('@')[0]] = result.title.toLowerCase()
})
await sleep(60000)
if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0])) {
man.sendButtonText(m.chat, [{ buttonId: 'tebak kabupaten', buttonText: { displayText: 'Tebak Kabupaten' }, type: 1 }], "Waktu Habis\nJawaban: " + result.title , `© ${ownername}`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
}
}
 case 'tebakkimia':{
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendText(m.chat, `Apa Arti Dari Simbol : *${result.lambang}*?\nWaktu : 60s`, m).then(() => {
console.log("Jawaban: " + result.unsur)
tebakkimia[m.sender.split('@')[0]] = result.unsur.toLowerCase()
})
await sleep(60000)
if (tebakkimia.hasOwnProperty(m.sender.split('@')[0])) {
man.sendButtonText(m.chat, [{ buttonId: 'tebak kimia', buttonText: { displayText: 'Tebak Kimia' }, type: 1 }], "Waktu Habis\nJawaban: " + result.unsur , `© ${ownername}`, m)
delete tebakkimia[m.sender.split('@')[0]]
}
} 
case 'tebaklirik': {
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
man.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
...
man.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], "Waktu Habis\nJawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebaktebakan[m.sender.split('@')[0]]
}
}
break
...
let result = anu[Math.floor(Math.random() * anu.length)]
man.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
console.log("Jawaban: " + result.jawaban)
...
man.sendButtonText(m.chat, [{ buttonId: 'caklontong', buttonText: { displayText: 'Cak Lontong' }, type: 1 }], `Waktu Habis\nJawaban : ${result.jawaban}\nDeskripsi : ${result.deskripsi}` , `© ${ownername}`, m)
delete caklontong[m.sender.split('@')[0]]
}
}
break
...
man.sendButtonText(m.chat, [{ buttonId: 'susunkata', buttonText: { displayText: 'Susun Kata' }, type: 1 }], `Waktu Habis\nJawaban : ${result.jawaban}` , `© ${ownername}`, m)
delete susunkata[m.sender.split('@')[0]]
}
}
break
...
if (tekateki.hasOwnProperty(m.sender.split('@')[0])) {
	man.sendButtonText(m.chat, [{ buttonId: 'tekateki', buttonText: { displayText: 'Teka Teki' }, type: 1 }], `Waktu Habis\nJawaban : ${result.jawaban}` , `© ${ownername}`, m)
delete tekateki[m.sender.split('@')[0]]
}
}
break
			...
			man.sendList(from, 'Mau set menu bang ?', `© ${ownername}`, salam + ' ' +  pushname, 'KLIK DISINI', [
							{
								"title": "Set Menu-1",
								"rows": [
									{
                ...
                if (!listhades.includes(text)) return man.sendList(from, 'Mau set menu bang ?', `© ${ownername}`, salam + ' ' + pushname, 'KLIK DISINI', [
							{
								"title": "Set Menu-1",
								"rows": [
									{
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await man.sendImageAsSticker(m.chat, media, m, { packname: text.split("|")[0], author: text.split("|")[1] })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply(`Kirim/Reply Gambar/Video Dengan Caption ${prefix + command}\n\nDurasi Sticker Video 1-9 Detik☕`)
let media = await quoted.download()
let encmedia = await man.sendVideoAsSticker(m.chat, media, m, { packname: text.split("|")[0], author: text.split("|")[1] })
await fs.unlinkSync(encmedia)
} else {
reply(`Kirim/Reply Gambar/Video Dengan Caption ${prefix + command}\n\nDurasi Sticker Video 1-9 Detik☕`)
}
...
break
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
			case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Man, 12, 1, 2004, Clara, 22, 2, 2004`
                let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
                let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Nama Suami :* ${anu.message.suami.nama}\n⭔ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n⭔ *Nama Istri :* ${anu.message.istri.nama}\n⭔ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} Man`
                let anu = await primbon.arti_nama(text)
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} Man, 12, 1, 2004`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} Man|Clara`
                let [nama1, nama2] = text.split`|`
                let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
                if (anu.status == false) return m.reply(anu.message)
                man.sendImage(m.chat,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendImage(m.chat, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} Man, 1, 2004\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            case 'haribaik': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} Man, 12, 1, 2004, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
            ...
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                man.sendText(m.chat, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break 
//ephoto360
...
if (!text) return reply(`Kirim perintah ${prefix + command} *Man*`)
reply(lang.wait())
...
if (!text) return reply(`Kirim perintah ${prefix + command} *Man|ofc*`)
if (!text.includes('|')) return reply(`Kirim perintah ${prefix + command} *Man|ofc*`)
mm = args.join(' ')
m1 = mm.split("|")[0];
m2 = mm.split("|")[1]; 
reply(lang.wait())
...
case 'hentai': {
			if (!db.data.chats[m.chat].nsfw) return reply('Fitur nsfw belum di aktifkan')
                ...
                anu = await hentai()
                result = anu[Math.floor(Math.random(), anu.length)]
                man.sendMessage(m.chat, { video: { url: result.video_1 }, caption: `⭔ Title : ${result.title}\n⭔ Category : ${result.category}\n⭔ Mimetype : ${result.type}\n⭔ Views : ${result.views_count}\n⭔ Shares : ${result.share_count}\n⭔ Source : ${result.link}\n⭔ Media Url : ${result.video_1}` }, { quoted: m })
            }
            break
...
man.sendMessage(from, { audio: { url :sound1} , mimetype: 'audio/mpeg', ptt:true}, {quoted: m})
.catch((e) =>{
reply(lang.err())
})
}
case 'coverbannerlol':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Man|jinx7`)
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
}}
	break
case 'pubglogomaker':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|women`)
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'astronotspace':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|anubis`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|anubis`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Man|allain`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Man|allain`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'bannerofaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|aphelios`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|aphelios`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'cutegirlgamer':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|style-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|style-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'footballteam':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|nau-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|nau-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
reply(listt)
	...
	reply(lang.wait())
let textpro2 = (api('alfa', '/api/ephoto360/'+command, {text: m1, logo : m2}, 'apikey'))
man.sendMessage(from, {video:{ url: textpro2}, mimetype: 'video/mp4', caption: lang.ok()}, {quoted:m})
}}

	break
case 'gaminglogo4fvs':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|ghost`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|ghost`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'blueneon':{
		if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|tiger`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Man|tiger`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'anonymous':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|style2`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|style2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'lolpentakill':{
		if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|kassadin`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|kassadin`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|arum-6`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|arum-6`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'avatarff':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|laura`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|laura`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|ashe-2`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Man|ashe-2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirecover':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|blthefates`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|blthefates`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|dieuthuyen`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Man|dieuthuyen`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'newlolavatar':{
if (!text) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Man|rammus`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Man|rammus`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
man.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'csgocover':{
if (!text) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} Man|karambit`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} Man|karambit`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
case 'randomquran':{
	...
	.then(async data =>{
		...
		man.sendMessage(from, {audio: {url: short.ayah.audio.primary}, mimetype: 'audio/mpeg'}, {quoted:m})
		})
		.catch(e =>{
reply(lang.err())
})
...
case 'alquranaudio':{
	...
	let short = asma.result.data
		...
		man.sendMessage(from, {audio: {url: short.audio.primary}, mimetype: 'audio/mpeg'}, {quoted:m})
		reply(listt)
		.catch(e =>{
reply(lang.err())
})
...
man.sendImageAsSticker(m.chat, lp, m, { packname: global.packname, author: global.author })
.catch(e =>{
reply(lang.err())
})
}
